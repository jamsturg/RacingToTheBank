...
def initialize():
    ...
    config = AgentConfig(
        ...
        code_exec_docker_image = "frdel/agent-zero:latest",
        code_exec_docker_ports = { "22/tcp": 50022 },
        code_exec_docker_volumes = { 
            files.get_abs_path("work_dir"): {"bind": "/workspace", "mode": "rw"},
            files.get_abs_path("instruments"): {"bind": "/instruments", "mode": "ro"},
        },
        code_exec_ssh_enabled = True,
        code_exec_ssh_addr = "localhost",
        code_exec_ssh_port = 50022,
        code_exec_ssh_user = "agent",
        code_exec_ssh_pass = os.environ.get("SSH_PASSWORD", "default_password"),
        additional = {},
    )
